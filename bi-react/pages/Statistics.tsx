...
export const Statistics: React.FC = () => {
  ...
  const stats = [
    ...
    {
       label: lang === 'en' ? 'Users Online Now' : 'المستخدمون المتواجدون الآن',
       value: onlineUsers,
       icon: Radio,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-16 animate-fade-in">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">{s.title}</h1>
      ...
      <div className="mt-16 text-center bg-brand-gray/20 border border-white/5 p-8 rounded-2xl">
         <p className="text-gray-500 uppercase tracking-widest text-xs mb-2">{lang === 'en' ? 'Total Activity' : 'إجمالي النشاط'}</p>
