...
export const Notifications: React.FC = () => {
  const { lang, notifications, unreadNotificationsCount, markNotificationAsRead, markAllNotificationsAsRead, deleteNotification, clearAllNotifications } = useStore();
             ...
             {filteredList.map((n) => (
               ...
               >
                  <div className="flex">
                     ...
                     {/* Actions Column (Visible always but subtle) */}
