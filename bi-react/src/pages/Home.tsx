  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh] bg-brand-black">
        ...
        <p className="mt-6 text-brand-gold font-medium animate-pulse tracking-widest uppercase text-xs">
          {t("common.loading")}
        </p>
      </div>
    );
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto space-y-8 animate-fade-in-up">
          ...
          <div className="flex flex-col items-center mb-4">
            <div className="relative group">
              ...
              <Logo
                src={homeData.logo_url || undefined}
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-4">
            <Link
              to="/projects"
              className="bg-gold-gradient text-black px-10 py-5 rounded-full font-black text-xl hover-scale glow-on-hover transition duration-300 shadow-2xl shadow-brand-gold/30 min-w-[200px]"
            >
              {t("hero.cta")}
            </Link>
            <Link
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 gap-6">
            <div className="text-center md:text-start">
              ...
              <p className="text-gray-400 text-lg max-w-2xl">
                {t("home.latestOpportunitiesDesc")}
              </p>
            </div>
            <Link
              to="/projects"
              className="group flex items-center gap-3 text-brand-gold hover:text-white transition-all font-black text-lg"
            >
              ...
              >
                ...
                <div className="h-64 w-full relative overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <FavoriteButton projectId={opportunity.id} />
                  </div>
                ...
                <div className="p-6 relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-6 border-t border-white/10">
                    <div className="flex flex-col gap-1">
                      ...
                      <Money
                        value={opportunity.investment_required}
                        className="text-lg font-black text-white font-sans"
                      />
                    </div>
      ...
      <section className="py-24 bg-brand-dark relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 w-full relative z-10">
          ...
          <div className="text-center mt-16">
            <Link
              to="/categories"
              className="inline-flex items-center gap-2 text-brand-gold hover:text-white transition-all font-bold text-lg border-b-2 border-brand-gold/20 hover:border-brand-gold pb-1"
            >
          ...
          <div className="glass-card p-12 rounded-[40px] border-white/5 shadow-inner">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-white">{t('nav.verified')}</span>
              </div>
              <div className="flex items-center gap-3">
                <Shield className="text-brand-gold" />
                <span className="font-bold text-white">{t('nav.secure')}</span>
              </div>
              <div className="flex items-center gap-3">
                <Shield className="text-brand-gold" />
                <span className="font-bold text-white">{t('nav.anonymous')}</span>
              </div>
            </div>
          </div>
        </div>
