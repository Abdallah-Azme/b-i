...
export const RegisterTypeClient: React.FC = () => {
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        ...
        <div className="text-center mt-6">
          <button onClick={() => router.push('/login-type')} className="text-sm text-brand-gold hover:text-white transition font-medium">
